  ...
  return (
    ...
    <Header navPosition="right" className="reveal-from-bottom" />
        ...
        <Switch>
          ...
          <AppRoute exact path="/individuals" component={IndividualsContent} layout={LayoutDefault}/>
          <AppRoute exact path="/retailers" component={Retailers} layout={LayoutDefault}/>
